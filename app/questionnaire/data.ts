...
export const PROFILES: Record<ProfileId, Profile> = {
  ...
  "cyclo-fuhrer": {
    ...
    description:
      "Tu fas trafailler à félo et tu es ein poil psychorigide sur les règles… mais seulement pour les foitures ja. Toi tu grilles les feux, tu roules sur les trottoirs et tu klaxonnes les piétons. Et alors ? C'est TA ville, tu l'as compris, et tu le fais comprendre aux étrangers sur ton espace vital.",
    accentColor: "#8B5CF6",
    bgColor: "#110820",
  },
  gourmand: {
    id: "gourmand",
    name: "Le Rondelle Gourmande",
    emoji: "🍩",
